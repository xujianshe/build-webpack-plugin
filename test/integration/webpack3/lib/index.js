    ...
    execute(compiler, { env }) {
        ...
        compiler.plugin("normal-module-factory", nmf => {
            nmf.plugin("factory", factory => async (data, cb) => {
                //var _ref = (0, _asyncToGenerator2.default)(function* (data, cb) {
                ...
                //const varName = _this.mytest(modulePath); //_this.addModule(contextPath, modulePath, { env });

                if (modulePath == "react") {
                    cb(null, new _ExternalModule("React", 'var', modulePath));
                }
                if (modulePath == "react-dom") {
                    cb(null, new _ExternalModule("ReactDOM", 'var', modulePath));
                } else {
                    factory(data, cb);
                }
        ...
        //             const varName = yield _this.mytest(modulePath); //_this.addModule(contextPath, modulePath, { env });
        ...
        //                 cb(null);
        //             } else {
        //                 cb(null, new _ExternalModule(varName, 'var', modulePath));
        //             }
        //         });
